<template>
  <div class="modal fade" :id="'ApprovalDialog-modal_' + this.reference.approval.event_id.substring(1)" tabindex="-1" aria-labelledby="ApprovalDialog-label" aria-hidden="true">
...
export default defineComponent({
  ...
  mounted () {
    const id = 'ApprovalDialog-modal_' + this.reference?.approval.event_id.substring(1)
